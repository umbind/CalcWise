  ...
  return (
    <>
      ...
      <button
        ...
        className={`hidden sm:flex items-center justify-between space-x-2 px-3 py-1.5 h-9 rounded-lg border border-slate-200 bg-slate-50/80 hover:bg-slate-100/90 text-slate-500 hover:text-slate-800 text-xs transition duration-150 shadow-2xs group focus:outline-none focus:ring-2 focus:ring-brand-primary overflow-hidden ${className}`}
        aria-label="Search calculators"
      >
        <div className="flex items-center space-x-2 min-w-0 mr-1.5">
          <svg
            className="w-3.5 h-3.5 text-slate-400 group-hover:text-brand-primary transition shrink-0"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <span className="font-medium text-slate-600 group-hover:text-slate-900 truncate whitespace-nowrap">
            Search 50+ tools...
          </span>
        </div>
        <kbd translate="no" className="notranslate shrink-0 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-mono bg-white border border-slate-200 text-slate-400 group-hover:text-slate-600 shadow-2xs">
          Ctrl K
        </kbd>
      </button>
